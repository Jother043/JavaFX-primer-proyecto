...
public class RemoveClienteController implements javafx.fxml.Initializable {
     ...
     */
    public void RemoveClienteTabla() {
        Customers c = new Customers();
        // Verificar si existe el cliente.
        if(c.getNumber(nombreCliente.getText()) == 0 || nombreCliente.getText().equals("")){
    ...
    public void exitAndCloseConecctions(ActionEvent actionEvent) {
